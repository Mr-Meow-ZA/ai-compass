...
const myLive=read('my-compass-live.js');
...
required(index.indexOf('my-compass.js')<index.indexOf('my-compass-live.js'),'Live refresh must load after the My Compass UI/runtime.');
for(const file of ['community-config.js','community-data.js','my-compass-data.js','community.js','my-compass.js','my-compass-live.js'])required(manifest.runtimeModules.some(module=>module.path===file),`${file} is missing from the runtime manifest.`);
