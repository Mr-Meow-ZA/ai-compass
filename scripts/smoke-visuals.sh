...
echo "Rendered counts: home-guides=$HOME_GUIDES guides=$GUIDE_CARDS news-cards=$NEWS_CARDS article-headers=$ARTICLE_HEADERS mobile-hero=$MOBILE_HERO dashboard-examples=$DASH_EXAMPLES dashboard-quality=$DASH_QUALITY dashboard-phones=$DASH_PHONES"
