...
grep -q 'Google deploys WeatherNext 3' "$TMP/home.html" || { echo 'Newest Daily Brief did not render on home' >&2; exit 1; }
grep -q 'Today in AI' "$TMP/home-mobile.html" || { echo 'Today in AI did not render on mobile' >&2; exit 1; }
grep -q 'Google deploys WeatherNext 3' "$TMP/home-mobile.html" || { echo 'Newest Daily Brief did not render on mobile home' >&2; exit 1; }
