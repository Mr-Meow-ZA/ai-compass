...
[[ "$(grep -o 'class="intel-news-row' "$TMP/news.html" | wc -l | tr -d ' ')" -ge 20 ]] || { echo 'Full news briefing did not preserve the feed' >&2; exit 1; }
...
echo 'Signal and curriculum rendered smoke OK.'