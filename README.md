...
**Current release baseline: 0.6.15 / build `2026-08-15.1`.**
...
The current library preserves at least 32 original guides alongside structured learning paths, practical tips, reference terms, templates and curated discovery collections. Maintained reference coverage includes content provenance/C2PA, the distinction between open weights and Open Source AI, and Structured Outputs for schema-constrained AI workflows.
